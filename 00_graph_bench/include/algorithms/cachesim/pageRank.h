...
struct PageRankStats *pageRankPulCacheAnalysisGraphCSR(double epsilon,  uint32_t iterations, struct GraphCSR *graph);
struct PageRankStats *pageRankPushQuantizationGraphCSR(double epsilon,  uint32_t iterations, struct GraphCSR *graph);
